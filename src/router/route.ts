		...
		children: [
...

			{
				...
				children: [
					...
					},
					{
						path: '/info/loss',
						name: 'infoLoss',
						component: () => import('/@/views/info/loss/index.vue'),	
						meta: {
							title: 'message.router.infoLoss',
							isLink: '',
							isHide: false,	
							isKeepAlive: true,
							isAffix: false,
					...
					},
					{
						path: '/info/addLoss',
						name: 'infoAddLoss',
						component: () => import('/@/views/info/addLoss/index.vue'),	
						meta: {
							title: 'message.router.infoAddLoss',
							isLink: '',
							isHide: false,	
							isKeepAlive: true,
							isAffix: false,
...

			{
				...
				children: [
					...
					{
						path: '/admin/reviewLoss',
						name: 'adminReviewLoss',
						component: () => import('/@/views/admin/reviewLoss/index.vue'),
						meta: {
							title: 'message.router.adminReviewLoss',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
