			...
			<el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" v-for="(v, k) in state.homeOne" :key="k"
				...
				<div class="home-card-item flex">
					<div class="flex-margin flex w100" :class="` home-one-animation${k}`">
						<div class="flex-auto flex align-center"> <!-- 添加 flex 和 align-center 类 -->
...
import timeTable from '/@/views/fun/timeTable/timeTable3.vue';
import timeTableMap from '/@/views/fun/timeTable/timeTableMap.vue';
// 定义变量内容
