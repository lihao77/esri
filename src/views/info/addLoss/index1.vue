            ...
            <splitpanes class="default-theme" @resize="paneSize = $event[0].size" style="height: 100%"
                ...
                <pane :size="paneSize">
                    <div class="map-view"
                        ...
                        <Map id="addNewsMap" :is-selecting="isSelecting" @wkt-selected="handleWKTSelected" />
                    </div>
                </pane>
                    ...
                    <div class="sidebar" :style="{ 'width': '100%' }">
                        <el-card class="sidebar-card" style="border-radius: 0;"
                            ...
                            <el-row style="height: 100%;">
                                ...
                                <!-- 侧边栏内容 -->
                                <div class="sidebar-content" @wheel="handleWhell" @touchstart="handleTouchStart"
...
const handleTouchMove = (event) => {
    if (sidebarType.value === 'vertical') {
        ...
        if (deltaY > 0) {
            ...
            if (paneSize.value > sidebarStyle.vertical.minSize) {
                event.preventDefault();
                paneSize.value -= 0.5;
            }
        }
...
const sidebarStyle: SidebarStyleObject = reactive({
    horizontal: {
        ...
        minSize: 30,
        clickMapToMaxSize: 70,
        clickSidebarToMaxSize: 30,
        arrow: {
