<template>
    <doubleView :viewStyle="viewStyle" ref="doubleViewRef" :isTop="isTop" :flexible="false"
        ...
        <template #second-view>
            <newsTable :style="{ paddingTop: newsTablePaddingTop }" ref="newsTableRef" :isSelecting="isSelecting"
                @update:isTop="handleIsTopChange" @update:isWatching="handleIsWatchingChange"
                @delete:position="handleDeletePosition" @update:isSelecting="handleIsSelectingChange"
