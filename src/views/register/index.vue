        ...
        <div class="register-left">
            <div class="register-left-logo">
                ...
                <div class="register-left-logo-text">
                    ...
                    <span class="register-left-logo-text-msg">{{ getThemeConfig.globalViceTitleMsg }}</span>
                </div>
            </div>
            <div class="register-left-img">
                <img :src="loginMain" />
            </div>
            <img :src="loginBg" class="register-left-waves" />
        </div>
...
// 引入组件
const Register = defineAsyncComponent(() => import('/@/views/register/register.vue')); // 新增加的注册组件
