				...
				<el-card shadow="hover">
					...
					<div class="personal-info-box">
						<ul class="personal-info-ul">
							<li v-for="(v, k) in state.lossInfoList" :key="k" class="personal-info-li">
								<div class="personal-info-li-content">
									<p class="personal-info-li-title">{{ v.goods }}</p>
									<p class="personal-info-li-title">{{ v.status }}</p>
									<el-button v-if="v.status === '待领取'" type="text" size="normal"
										@click="handleDelete(v)">归档</el-button>
								</div>
							</li>
						...
						<el-row :gutter="35">
							...
							<el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="4" class="mb20">
								<el-form-item label="专业">
									<el-input v-model="state.personalForm.autograph" placeholder="请输入专业"
										clearable></el-input>
								</el-form-item>
							</el-col>
							<!-- <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="4" class="mb20">
...
import { lossInfoList, recommendList } from './mock';
...
const handleDelete = (v: any) => {
	state.lossInfoList.forEach((item) => {
		if(item.id == v.id){
			item.status = '已归档'
		}
		return item
